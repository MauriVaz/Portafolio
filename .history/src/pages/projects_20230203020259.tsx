            ...
            <ul className="flex flex-col text-center text-black">
                ...
                <li className="p-4 m-4 bg-gray-200 rounded-2xl">
                    ...
                    <div className="text-center flex flex-col md:flex-row-reverse p-4 justify-center items-center">
                        ...
                        <Link
                            ...
                            <Image className='mt-8 drop-shadow-xl shadow-lg shadow-blue-500/50' src={calculadora} alt="calculadora" width={1700} height={780} />
                        </Link>
                    </div>
                </li>
                <li className="p-4 m-4 bg-gray-200 rounded-2xl">
                    ...
                    <div className="text-center flex flex-col md:flex-row p-4 justify-center items-center">
                        ...
                        <Link
                            ...
                            <Image className='mt-8 drop-shadow-xl shadow-lg shadow-blue-500/50' src={pokedex} alt="pokedex" width={1170} height={780} />
                        </Link>
                    </div>
                </li>
                <li className="p-4 m-4 bg-gray-200 rounded-2xl">
                    ...
                    <div className="text-center flex flex-col md:flex-row-reverse p-4 justify-center items-center">
                        ...
                        <Link
                            ...
                            <Image className='mt-8 drop-shadow-xl shadow-lg shadow-blue-500/50' src={guess} alt="guess" width={720} height={480} />
                        </Link>
                    </div>
                </li>
                <li className="p-4 m-4 bg-gray-200 rounded-2xl">
                ...
                <li className="p-4 m-4 bg-gray-200 rounded-2xl">
                    ...
                    <div className="text-center flex flex-col md:flex-row-reverse p-4 justify-center items-center">
                        <div className="mx-5">
                            <p className='mb-4'>
                                Mi first project with the Javascript&#39;s framework Vue, this is a simple List, you can add, delete,
                                put a todo how finished, and search a todo
                            </p>
                        </div>
                        <Link
                            href={'https://github.com/MauriVaz/Primer-app-con-Vue'}>
                            <Image className='mt-8 drop-shadow-xl shadow-lg shadow-blue-500/50' src={Vue} alt="guess" width={720} height={480} />
                        </Link>
                    </div>
                </li>
            </ul>
